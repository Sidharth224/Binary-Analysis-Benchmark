...
export OUT_DIR=$DATABASE_HOME/zephyr-$ZEPHYR_VERSION/ARM-Boards
export ARCH=ARM

# Boards selected for binary generation
export BOARDS="qemu_cortex_m3 nrf5340_dk_nrf5340_cpuapp"
export BOARD_NAMES="ARM-Cortex-M3-Emulation-QEMU Nordic-nRF5340-DK"
