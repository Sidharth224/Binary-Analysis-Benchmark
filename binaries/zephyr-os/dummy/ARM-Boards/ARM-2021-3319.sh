...
export OUT_DIR=$DATASET_HOME/$CVENUM/ARM-Boards

# Boards selected for binary generation
export BOARDS="mimxrt1064_evk qemu_cortex_m3 nrf5340_dk_nrf5340_cpuapp stm32f769i_disco"
export BOARD_NAMES="NXP-MIMXRT1064-EVK ARM-Cortex-M3-Emulation-QEMU Nordic-nRF5340-DK ST-STM32F769I-Discovery"
