...
export OUT_DIR=$DATASET_HOME/$CVENUM/X86-Boards

# Boards selected for binary generation
export BOARDS="acrn minnowboard up_squared"
export BOARD_NAMES="ACRN-UOS MinnowBoard-Max Up-Squared"

export SAMPLE_DIR="$SAMPLE_HOME/bluetooth/beacon $SAMPLE_HOME/bluetooth/central $SAMPLE_HOME/boards/ti/cc13x2_cc26x2/system_off $SAMPLE_HOME/bluetooth/hci_pwr_ctrl
					...
					$SAMPLE_HOME/boards/up_squared/gpio_counter $SAMPLE_HOME/cpp_synchronization
